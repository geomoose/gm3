...
All contributors to GeoMoose are welcome. The PSC and maintainers wish to promote a welcoming environment for contributions both technical and non-technical. Bug reports are as welcome as patches.

## AI/LLM Policy

The GeoMoose project does not expressly discourage the use of AI/LLM tooling. However, the following guidelines are in force:
