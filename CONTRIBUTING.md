...
The GeoMoose Project Steering Committee and maintainers strive to promote a welcoming environment for all contributors.  We welcome both technical and non-technical contributions.
...
- [Security Issues](https://github.com/geomoose/gm3/security) — report security issue
...
2. All tests (including the linter) must pass.  (You can run `npm test` locally, or wait for result of the GitHub Action.)
...
Please respect the time and effort it takes for us to review your contributions.
...
2. Contributions must be reviewed and understood by a human.  For example, blindly copying and pasting responses from a LLM into a PR is not acceptable. The human making the contribution is responsible for their contribution(s).
